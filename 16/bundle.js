...
/* harmony export */ });
/* harmony import */ var _model_point_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/point-model */ "./src/model/point-model.js");
  ...
  constructor(endPoint, authorization) {
    ...
    _defineProperty(this, "addPoint", async point => {
      const response = await _classPrivateFieldGet(this, _load).call(this, {
        url: 'points',
        method: Method.POST,
        body: JSON.stringify(_model_point_model__WEBPACK_IMPORTED_MODULE_0__.PointsModel.adaptPointsToServer(point)),
        headers: new Headers({
...
/* harmony export */   "generateClearPoint": () => (/* binding */ generateClearPoint),
...
const allOffers = [new optionObject('Add breakfast', 50, 'restaurant').tripOffer, new optionObject('Add alchol', 50, 'restaurant').tripOffer, new optionObject('Add luggage', 50, 'flight').tripOffer, new optionObject('Rent a car', 80, 'drive').tripOffer, new optionObject('Add soft drinks', 15, 'bus').tripOffer, new optionObject('Book tickets', 40, 'sightseeing').tripOffer, new optionObject('Lunch in city', 30, 'sightseeing').tripOffer, new optionObject('Order Uber', 20, 'taxi').tripOffer, new optionObject('Add dinner', 20, 'train').tripOffer, new optionObject('Switch to comfort', 30, 'flight').tripOffer, new optionObject('Switch to luxe', 100, 'ship').tripOffer, new optionObject('Premium waiting area', 20, 'check-in').tripOffer, new optionObject('Switch to luxe', 50, 'transport').tripOffer, new optionObject('Add conditioner', 10, 'bus').tripOffer];
...
const sortPointPrice = (pointA, pointB) => {
  ...
  return weight !== null && weight !== void 0 ? weight : pointB.basePrice - pointA.basePrice;
};
const generatePoint = () => {
...
/* harmony import */ var _utilities_observer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utilities/observer.js */ "./src/utilities/observer.js");
/* harmony import */ var _presenter_point_presenter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../presenter/point-presenter.js */ "./src/presenter/point-presenter.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var _adaptPointToClient = /*#__PURE__*/new WeakMap();

var _adaptOffersToClient = /*#__PURE__*/new WeakMap();

class PointsModel extends _utilities_observer_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(apiService) {
    ...
    _defineProperty(this, "init", async () => {
      try {
        ...
        _classPrivateFieldSet(this, _points, points.map(point => _classPrivateFieldGet(this, _adaptPointToClient).call(this, point)));
      } catch (err) {
      ...
      try {
        ...
        _classPrivateFieldSet(this, _offers, offers.map(offer => _classPrivateFieldGet(this, _adaptOffersToClient).call(this, offer)));
      } catch (err) {
        _classPrivateFieldSet(this, _offers, []);
      }

      _classPrivateFieldSet(this, _destinations, await _classPrivateFieldGet(this, _apiService).destinations);

      this._notify(_const_js__WEBPACK_IMPORTED_MODULE_0__.UpdateType.INIT);
    });

    _defineProperty(this, "updatePoint", async (updateType, update, Abort) => {
      ...
      try {
        ...
        const updatedPoint = _classPrivateFieldGet(this, _adaptPointToClient).call(this, response);

        _classPrivateFieldSet(this, _points, [..._classPrivateFieldGet(this, _points).slice(0, index), updatedPoint, ..._classPrivateFieldGet(this, _points).slice(index + 1)]);

        this._notify(updateType, updatedPoint);
      } catch {
        Abort(_presenter_point_presenter_js__WEBPACK_IMPORTED_MODULE_2__.State.ABORTING);
      }
    });

    _defineProperty(this, "addPoint", async (updateType, update, Abort) => {
      try {
        const response = await _classPrivateFieldGet(this, _apiService).addPoint(update);

        const newPoint = _classPrivateFieldGet(this, _adaptPointToClient).call(this, response);
    ...
    _defineProperty(this, "deletePoint", async (updateType, update, Abort) => {
      const index = _classPrivateFieldGet(this, _points).findIndex(point => point.id === update.id);
    ...
    _classPrivateFieldInitSpec(this, _adaptPointToClient, {
      writable: true,
      value: point => {
        let action = 'to';
        ...
        for (let i = 0; i < point.offers.length; i++) {
          offers.push({
            type: point.type,
            option: point.offers[i].title,
            price: point.offers[i].price,
            id: point.offers[i].id
          });
        }
    ...
    _classPrivateFieldInitSpec(this, _adaptOffersToClient, {
      writable: true,
      value: elderOffer => {
  ...
  get destinations() {
    return _classPrivateFieldGet(this, _destinations);
  }

  get offers() {
    return _classPrivateFieldGet(this, _offers);
  }

}

_defineProperty(PointsModel, "adaptPointsToServer", point => {
  const adaptedOffers = [];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EventNew": () => (/* binding */ EventNew)
/* harmony export */ });
/* harmony import */ var _view_site_edit_point_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/site-edit-point-view.js */ "./src/view/site-edit-point-view.js");
...
var _setActiveButton = /*#__PURE__*/new WeakMap();
...
class EventNew {
  constructor(eventListContainer, changeData, setActiveButton) {
    ...
    _classPrivateFieldInitSpec(this, _setActiveButton, {
      writable: true,
      value: null
    });

    _defineProperty(this, "setAborting", () => {
      const resetFormState = () => {
        _classPrivateFieldGet(this, _eventEditComponent).updateData({
          isDisabled: false,
          isSaving: false,
          isDeleting: false
        });
      ...
      _classPrivateFieldGet(this, _eventEditComponent).shake(resetFormState);
    });

    _defineProperty(this, "_handleFormSubmit", tripPoint => {
      _classPrivateFieldGet(this, _changeData).call(this, _const_js__WEBPACK_IMPORTED_MODULE_2__.UserAction.ADD_POINT, _const_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MINOR, tripPoint);

      document.addEventListener('keydown', this._escKeyDownHandler);
    });

    _defineProperty(this, "_handleDeleteClick", () => {
      this.destroy();
    });
    ...
    _classPrivateFieldSet(this, _setActiveButton, setActiveButton);
  ...
  init(allOffers, destinations) {
    ...
    _classPrivateFieldSet(this, _eventEditComponent, new _view_site_edit_point_view_js__WEBPACK_IMPORTED_MODULE_0__.SiteEditPointView(generateClearPoint(destinations[0], allOffers[0]), allOffers, destinations));

    _classPrivateFieldGet(this, _eventEditComponent).setFormSubmitHandler(this._handleFormSubmit);

    _classPrivateFieldGet(this, _eventEditComponent).setDeleteClickHandler(this._handleDeleteClick);

    _classPrivateFieldGet(this, _eventEditComponent).setEditClickHandler(this._handleDeleteClick);
  }

  get editComponent() {
    return _classPrivateFieldGet(this, _eventEditComponent).element;
  }
  ...
  destroy() {
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.remove)(_classPrivateFieldGet(this, _eventEditComponent));

    _classPrivateFieldSet(this, _eventEditComponent, null);

    _classPrivateFieldGet(this, _setActiveButton).call(this);
...
/* harmony import */ var _utilities_common_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utilities/common.js */ "./src/utilities/common.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var _allOffers = /*#__PURE__*/new WeakMap();
...
var _setSubmitClick = /*#__PURE__*/new WeakMap();

var _setFavoriteClick = /*#__PURE__*/new WeakMap();

var _setDeleteClick = /*#__PURE__*/new WeakMap();
...
class PointPresenter {
  constructor(tripListElement, changeData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _allOffers, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _mode, {
      writable: true,
      value: _const_js__WEBPACK_IMPORTED_MODULE_3__.Mode.DEFAULT
    });

    _defineProperty(this, "init", (pointObject, allOffers, destinations) => {
      _classPrivateFieldSet(this, _pointObject, pointObject);

      _classPrivateFieldSet(this, _allOffers, allOffers);
      ...
      _classPrivateFieldSet(this, _pointEditComponent, new _view_site_edit_point_view_js__WEBPACK_IMPORTED_MODULE_1__.SiteEditPointView(_classPrivateFieldGet(this, _pointObject), allOffers, destinations));
      ...
      _classPrivateFieldGet(this, _pointEditComponent).setFormSubmitHandler(_classPrivateFieldGet(this, _setSubmitClick));

      _classPrivateFieldGet(this, _pointEditComponent).setDeleteClickHandler(_classPrivateFieldGet(this, _setDeleteClick));
    ...
    _classPrivateFieldInitSpec(this, _replacePointToForm, {
      ...
      value: () => {
        ...
        _classPrivateFieldSet(this, _mode, _const_js__WEBPACK_IMPORTED_MODULE_3__.Mode.EDITING);
      }
    });

    _defineProperty(this, "resetView", () => {
      if (_classPrivateFieldGet(this, _mode) !== _const_js__WEBPACK_IMPORTED_MODULE_3__.Mode.DEFAULT) {
        this.replaceFormToPoint();
      }
    });

    _defineProperty(this, "replaceFormToPoint", () => {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(_classPrivateFieldGet(this, _pointComponent).element, _classPrivateFieldGet(this, _pointEditComponent).element);

      _classPrivateFieldSet(this, _mode, _const_js__WEBPACK_IMPORTED_MODULE_3__.Mode.DEFAULT);
    });
    ...
    _classPrivateFieldInitSpec(this, _setSubmitClick, {
      writable: true,
      value: update => {
        const isMinorUpdate = !(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_4__.isDatesEqual)(_classPrivateFieldGet(this, _pointObject).dateFrom, update.dateFrom) || !(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_4__.isDatesEqual)(_classPrivateFieldGet(this, _pointObject).dateTo, update.dateTo) || _classPrivateFieldGet(this, _pointObject).townName !== update.townName || _classPrivateFieldGet(this, _pointObject).basePrice !== update.basePrice;

        _classPrivateFieldGet(this, _changeData).call(this, _const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, isMinorUpdate ? _const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR : _const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, update);
    ...
    _classPrivateFieldInitSpec(this, _setFavoriteClick, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _changeData).call(this, _const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, _const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.PATCH, { ..._classPrivateFieldGet(this, _pointObject)
        });
      }
    });

    _classPrivateFieldInitSpec(this, _setDeleteClick, {
      writable: true,
      value: point => {
...
/* harmony import */ var _utilities_common_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utilities/common.js */ "./src/utilities/common.js");
/* harmony import */ var _view_site_no_point_view_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/site-no-point-view.js */ "./src/view/site-no-point-view.js");
/* harmony import */ var _point_presenter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./point-presenter.js */ "./src/presenter/point-presenter.js");
/* harmony import */ var _new_event_presenter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./new-event-presenter.js */ "./src/presenter/new-event-presenter.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _mock_mock_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../mock/mock.js */ "./src/mock/mock.js");
/* harmony import */ var _view_new_event_button_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../view/new-event-button.js */ "./src/view/new-event-button.js");
/* harmony import */ var _view_site_tab_view_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../view/site-tab-view.js */ "./src/view/site-tab-view.js");
...
var _siteTabComponent = /*#__PURE__*/new WeakMap();

var _newPointButton = /*#__PURE__*/new WeakMap();
...
var _tripListContainer = /*#__PURE__*/new WeakMap();

var _tripControlsContainer = /*#__PURE__*/new WeakMap();
...
var _handlerFilterTypeChange = /*#__PURE__*/new WeakMap();

var _getAllFilters = /*#__PURE__*/new WeakMap();
...
var _renderPointsList = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(tripListContainer, tripControlsContainer, tripMainContainer, pointsModel) {
    _classPrivateFieldInitSpec(this, _siteTabComponent, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(this, _newPointButton, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _tripListContainer, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(this, _tripControlsContainer, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _sortType, {
      writable: true,
      value: _const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.DEFAULT
    });
    ...
    _defineProperty(this, "init", () => {
      ...
      _classPrivateFieldSet(this, _sortComponent, new _view_site_list_sort_view_js__WEBPACK_IMPORTED_MODULE_1__.SiteSortView());

      _classPrivateFieldSet(this, _newPointButton, new _view_new_event_button_js__WEBPACK_IMPORTED_MODULE_9__.NewPointButton());

      _classPrivateFieldSet(this, _filtersComponent, new _view_site_filter_view_js__WEBPACK_IMPORTED_MODULE_2__.Filter(_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING));

      _classPrivateFieldGet(this, _newPointButton).setNewEventButtonHandler(this._buttonHandler);

      (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripControlsContainer), _classPrivateFieldGet(this, _newPointButton).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTEREND);
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripListContainer), _classPrivateFieldGet(this, _sortComponent).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREBEGIN);
    ...
    _classPrivateFieldInitSpec(this, _handlerFilterTypeChange, {
      writable: true,
      value: filterType => {
        if (_classPrivateFieldGet(this, _filterType) === filterType) {
          return;
        }

        _classPrivateFieldSet(this, _filterType, filterType);

        _classPrivateFieldGet(this, _handleModelEvent).call(this, 'MAJOR');
      }
    });

    _classPrivateFieldInitSpec(this, _getAllFilters, {
      writable: true,
      value: () => ({
        everything: _utilities_common_js__WEBPACK_IMPORTED_MODULE_3__.filter[_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING](_classPrivateFieldGet(this, _pointsModel).points),
        past: _utilities_common_js__WEBPACK_IMPORTED_MODULE_3__.filter[_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.PAST](_classPrivateFieldGet(this, _pointsModel).points),
        future: _utilities_common_js__WEBPACK_IMPORTED_MODULE_3__.filter[_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.FUTURE](_classPrivateFieldGet(this, _pointsModel).points)
      })
    });
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: (actionType, updateType, update) => {
        switch (actionType) {
          case _const_js__WEBPACK_IMPORTED_MODULE_7__.UserAction.UPDATE_POINT:
            _classPrivateFieldGet(this, _pointPresenters).get(update.id).setViewState(_point_presenter_js__WEBPACK_IMPORTED_MODULE_5__.State.SAVING);

            _classPrivateFieldGet(this, _pointsModel).updatePoint(updateType, update, _classPrivateFieldGet(this, _pointPresenters).get(update.id).setViewState);

            break;

          case _const_js__WEBPACK_IMPORTED_MODULE_7__.UserAction.ADD_POINT:
            _classPrivateFieldGet(this, _eventNewPresenter).setSaving();

            _classPrivateFieldGet(this, _pointsModel).addPoint(updateType, update, _classPrivateFieldGet(this, _eventNewPresenter).setAborting);

            break;

          case _const_js__WEBPACK_IMPORTED_MODULE_7__.UserAction.DELETE_POINT:
            _classPrivateFieldGet(this, _pointPresenters).get(update.id).setViewState(_point_presenter_js__WEBPACK_IMPORTED_MODULE_5__.State.DELETING);

            _classPrivateFieldGet(this, _pointsModel).deletePoint(updateType, update, _classPrivateFieldGet(this, _pointPresenters).get(update.id).setViewState);
      ...
      value: (updateType, data) => {
        switch (updateType) {
          case _const_js__WEBPACK_IMPORTED_MODULE_7__.UpdateType.PATCH:
            _classPrivateFieldGet(this, _pointPresenters).get(data.id).init(data, _classPrivateFieldGet(this, _pointsModel).offers, _classPrivateFieldGet(this, _destinations));
          ...
          case _const_js__WEBPACK_IMPORTED_MODULE_7__.UpdateType.MAJOR:
            _classPrivateFieldGet(this, _clearEventsList).call(this, true);
          ...
          case _const_js__WEBPACK_IMPORTED_MODULE_7__.UpdateType.INIT:
            ...
            (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _loadingComponent));
    ...
    _classPrivateFieldInitSpec(this, _renderPoint, {
      writable: true,
      value: point => {
        _classPrivateFieldSet(this, _totalPrice, _classPrivateFieldGet(this, _totalPrice) + Number(point.basePrice));

        const pointPresenter = new _point_presenter_js__WEBPACK_IMPORTED_MODULE_5__.PointPresenter(_classPrivateFieldGet(this, _tripListContainer), _classPrivateFieldGet(this, _handleViewAction), _classPrivateFieldGet(this, _handleModeChange));
        pointPresenter.init(point, _classPrivateFieldGet(this, _pointsModel).offers, _classPrivateFieldGet(this, _destinations));

        _classPrivateFieldGet(this, _pointPresenters).set(pointPresenter.pointId, pointPresenter);
      }
    });

    _classPrivateFieldInitSpec(this, _renderPointsList, {
      writable: true,
      value: () => {
        this.points.forEach(point => _classPrivateFieldGet(this, _renderPoint).call(this, point));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderBoard, {
      ...
      value: () => {
        ...
        _classPrivateFieldSet(this, _destinations, _classPrivateFieldGet(this, _pointsModel).destinations);

        _classPrivateFieldSet(this, _eventNewPresenter, new _new_event_presenter_js__WEBPACK_IMPORTED_MODULE_6__.EventNew(_classPrivateFieldGet(this, _tripListContainer), _classPrivateFieldGet(this, _handleViewAction), this.setActiveButton));

        _classPrivateFieldGet(this, _eventNewPresenter).init(_classPrivateFieldGet(this, _pointsModel).offers, _classPrivateFieldGet(this, _destinations));

        if (_classPrivateFieldGet(this, _pointsModel).points.length === 0) {
          (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _sortComponent));
        ...
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _noPointComponent));

        _classPrivateFieldGet(this, _renderSort).call(this);

        _classPrivateFieldGet(this, _renderPointsList).call(this);

        _classPrivateFieldGet(this, _filtersComponent).init(_classPrivateFieldGet(this, _getAllFilters).call(this), _classPrivateFieldGet(this, _filterType));

        _classPrivateFieldGet(this, _filtersComponent).setFilterTypeChangeHandler(_classPrivateFieldGet(this, _handlerFilterTypeChange));

        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripControlsContainer), _classPrivateFieldGet(this, _filtersComponent).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);

        _classPrivateFieldSet(this, _siteTabComponent, new _view_site_tab_view_js__WEBPACK_IMPORTED_MODULE_10__.SiteTabView(_classPrivateFieldGet(this, _totalPrice), _classPrivateFieldGet(this, _pointsModel).points));

        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripMainContainer), _classPrivateFieldGet(this, _siteTabComponent).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderNoPoint, {
      writable: true,
      value: () => {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripListContainer), _classPrivateFieldGet(this, _noPointComponent).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderLoading, {
      writable: true,
      value: () => {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripListContainer), _classPrivateFieldGet(this, _loadingComponent).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
      }
    });

    _classPrivateFieldInitSpec(this, _clearEventsList, {
      writable: true,
      value: (resetSortType = false) => {
        _classPrivateFieldSet(this, _totalPrice, 0);
        ...
        _classPrivateFieldSet(this, _pointPresenters, new Map());

        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _siteTabComponent));
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _filtersComponent));

        if (resetSortType) {
          _classPrivateFieldSet(this, _sortType, _const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.DEFAULT);
        }
      }
    });

    _defineProperty(this, "_buttonHandler", () => {
      _classPrivateFieldGet(this, _eventNewPresenter).init(_classPrivateFieldGet(this, _pointsModel).offers, _classPrivateFieldGet(this, _destinations));

      const editingComponent = Array.from(_classPrivateFieldGet(this, _pointPresenters).values()).find(presenter => presenter.mode === _const_js__WEBPACK_IMPORTED_MODULE_7__.Mode.EDITING);

      if (editingComponent !== undefined) {
        editingComponent.replaceFormToPoint();
      }

      (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripListContainer), _classPrivateFieldGet(this, _eventNewPresenter).editComponent, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);

      _classPrivateFieldGet(this, _newPointButton).setDisable();
    });

    _defineProperty(this, "setActiveButton", () => {
      _classPrivateFieldGet(this, _newPointButton).removeDisable();
    });

    _classPrivateFieldSet(this, _tripListContainer, tripListContainer);

    _classPrivateFieldSet(this, _tripControlsContainer, tripControlsContainer);

    _classPrivateFieldSet(this, _tripMainContainer, tripMainContainer);

    _classPrivateFieldSet(this, _filterType, _const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING);

    _classPrivateFieldSet(this, _pointsModel, pointsModel);

    _classPrivateFieldSet(this, _noPointComponent, new _view_site_no_point_view_js__WEBPACK_IMPORTED_MODULE_4__.SiteNoPointView());

    _classPrivateFieldSet(this, _loadingComponent, new _view_loading_js__WEBPACK_IMPORTED_MODULE_11__.Loading());
  }

  get points() {
    const filteredPoints = _utilities_common_js__WEBPACK_IMPORTED_MODULE_3__.filter[_classPrivateFieldGet(this, _filterType)](_classPrivateFieldGet(this, _pointsModel).points);

    switch (_classPrivateFieldGet(this, _sortType)) {
      case _const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.PRICE:
        return filteredPoints.slice(0).sort(_mock_mock_js__WEBPACK_IMPORTED_MODULE_8__.sortPointPrice);

      case _const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.TIME:
        return filteredPoints.slice(0).sort(_mock_mock_js__WEBPACK_IMPORTED_MODULE_8__.sortPointTime);
  ...
  destroy() {
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _sortComponent));
    (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _filtersComponent));
    (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _newPointButton));

    _classPrivateFieldGet(this, _eventNewPresenter).destroy();

    _classPrivateFieldSet(this, _sortComponent, null);

    _classPrivateFieldGet(this, _pointsModel).removeObserver(_classPrivateFieldGet(this, _handleModelEvent));
  }
...
/* harmony export */   "humanizeDateInput": () => (/* binding */ humanizeDateInput),
...
const isDatesEqual = (dateA, dateB) => {
  ...
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB, 'day');
};
const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING]: events => events.slice(),
  [_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.FUTURE]: events => events.filter(task => task.dateTo > new Date()),
  [_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.PAST]: events => events.filter(task => task.dateTo < new Date())
};
...
class Observer {
  constructor() {
    ...
    _defineProperty(this, "removeObserver", observer => {
      _classPrivateFieldSet(this, _observers, _classPrivateFieldGet(this, _observers).filter(existedObserver => existedObserver !== observer));
    });
...
const createMenuTemplate = () => `<div class="trip-controls__navigation">
    ...
    <nav class="trip-controls__trip-tabs  trip-tabs">
      <a class="trip-tabs__btn  trip-tabs__btn--active" href="#" data-menu="${_const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.TABLE}">${_const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.TABLE}</a>
      <a class="trip-tabs__btn" href="#" data-menu="${_const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.STATS}">${_const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.STATS}</a>
    </nav>
  </div>`;

var _currentMenuItem = /*#__PURE__*/new WeakMap();
...
class Menu extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _currentMenuItem, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _menuClickHandler, {
      ...
      value: evt => {
        ...
        if (_classPrivateFieldGet(this, _currentMenuItem) === evt.target.dataset.menu) {
          return;
        }
    ...
    _classPrivateFieldSet(this, _currentMenuItem, _const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.TABLE);

    _classPrivateFieldSet(this, _menuClickHandler, _classPrivateFieldGet(this, _menuClickHandler).bind(this));
  }
  ...
  setMenuClickHandler(callback) {
    ...
    Array.from(this.getElement().querySelectorAll('.trip-tabs__btn')).forEach(it => {
      it.addEventListener('click', _classPrivateFieldGet(this, _menuClickHandler));
    });
  }

  setMenuDisable(menuItem) {
    _classPrivateFieldSet(this, _currentMenuItem, menuItem);
...
var _newEventButtonHandler = /*#__PURE__*/new WeakMap();

class NewPointButton extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    super(...args);

    _defineProperty(this, "setNewEventButtonHandler", callback => {
      this._callback.newEventClick = callback;
      this.getElement().addEventListener('click', _classPrivateFieldGet(this, _newEventButtonHandler));
    });

    _classPrivateFieldInitSpec(this, _newEventButtonHandler, {
      writable: true,
      value: () => {
...
/* harmony export */ });
/* harmony import */ var _utilities_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utilities/common.js */ "./src/utilities/common.js");
/* harmony import */ var _smart_view_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./smart-view.js */ "./src/view/smart-view.js");
/* harmony import */ var _mock_mock_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/mock.js */ "./src/mock/mock.js");
...
const createEditEventOfferTemplate = (offerOfType, offers, type, isDisabled) => {
...
const createEditEventTypeTemplate = (eventTypeName, eventType, isDisabled) => `<div class="event__type-item">
                              ...
                              ${isDisabled ? 'disabled' : ''}>
                              <label class="event__type-label  event__type-label--${eventType.name}" for="event-type-${eventType.name}-1">${(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_0__.upCaseFirst)(eventType.name)}</label>
                            </div>`;
...
const createEventFormTemplate = (newPoint, allOffers, destinations) => {
  ...
  return `
      ...
      <div class="event__type-list">
        <fieldset class="event__type-group">
          <legend class="visually-hidden">Transfer</legend>
             ${Object.values(_mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.eventTypes).filter(it => it.action === 'to').map(it => createEditEventTypeTemplate(eventTypeName, it, isDisabled)).join('\n')}
        </fieldset>
        <fieldset class="event__type-group">
          <legend class="visually-hidden">Activity</legend>
             ${Object.values(_mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.eventTypes).filter(it => it.action === 'in').map(it => createEditEventTypeTemplate(eventTypeName, it, isDisabled)).join('\n')}
        </fieldset>
      </div>
    </div>
    ...
    <label class="event__label  event__type-output" for="event-destination-1">
      ${(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_0__.upCaseFirst)(eventTypeName)} ${type.action}
    </label>
      ...
      ${destinations.map(it => `<option value="${it.name}"></option>`).join('\n')}
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time"
            value="${(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_0__.humanizeDateInput)(dateFrom)}"
            ${isDisabled ? 'disabled' : ''}>
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" 
          value="${(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_0__.humanizeDateInput)(dateTo)}"
          ${isDisabled ? 'disabled' : ''}>
        </div>
      ...
      <section class="event__details">
        <section class="event__section  event__section--offers">
          ...
          <div class="event__available-offers">
            ${allOffersOfType === undefined ? offers.map(it => createEditEventOfferTemplate(it, offers, type, isDisabled)).join('\n') : allOffersOfType.offers.map(it => createEditEventOfferTemplate(it, offers, type, isDisabled)).join('\n')}
          </div>
        </section>
      </section>
...
var _allOffersOfType = /*#__PURE__*/new WeakMap();

var _datepickerStart = /*#__PURE__*/new WeakMap();

var _datepickerFinish = /*#__PURE__*/new WeakMap();

var _setDatepicker = /*#__PURE__*/new WeakMap();

var _startDateChangeHandler = /*#__PURE__*/new WeakMap();

var _finishDateChangeHandler = /*#__PURE__*/new WeakMap();

var _updateTripDuration = /*#__PURE__*/new WeakMap();
...
class SiteEditPointView extends _smart_view_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(newPoint, allOffers, destinations) {
    ...
    _classPrivateFieldInitSpec(this, _allOffersOfType, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(this, _datepickerStart, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(this, _datepickerFinish, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _setDatepicker, {
      writable: true,
      value: () => {
        if (_classPrivateFieldGet(this, _datepickerStart)) {
          _classPrivateFieldGet(this, _datepickerStart).destroy();

          _classPrivateFieldSet(this, _datepickerStart, null);
        }

        if (_classPrivateFieldGet(this, _datepickerFinish)) {
          _classPrivateFieldGet(this, _datepickerFinish).destroy();

          _classPrivateFieldSet(this, _datepickerFinish, null);
        }

        _classPrivateFieldSet(this, _datepickerStart, (0,flatpickr__WEBPACK_IMPORTED_MODULE_4__["default"])(this.getElement().querySelector('input[name = event-start-time]'), {
          dateFormat: 'd/m/y H:i',
          enableTime: true,
          time_24hr: true,
          // eslint-disable-line
          defaultDate: this._data.dateFrom,
          onChange: _classPrivateFieldGet(this, _startDateChangeHandler) // На событие flatpickr передаём наш колбэк

        }));

        _classPrivateFieldSet(this, _datepickerFinish, (0,flatpickr__WEBPACK_IMPORTED_MODULE_4__["default"])(this.getElement().querySelector('input[name = event-end-time]'), {
          dateFormat: 'd/m/y H:i',
          enableTime: true,
          time_24hr: true,
          // eslint-disable-line
          defaultDate: this._data.dateTo,
          onChange: _classPrivateFieldGet(this, _finishDateChangeHandler) // На событие flatpickr передаём наш колбэк

        }));

        _classPrivateFieldGet(this, _updateTripDuration).call(this);
      }
    });

    _classPrivateFieldInitSpec(this, _startDateChangeHandler, {
      writable: true,
      value: ([userStartDate]) => {
        this.updateData({
    ...
    _classPrivateFieldInitSpec(this, _finishDateChangeHandler, {
      writable: true,
      value: ([userFinishDate]) => {
        this.updateData({
    ...
    _classPrivateFieldInitSpec(this, _updateTripDuration, {
      writable: true,
      value: () => {
    ...
    _classPrivateFieldInitSpec(this, _formSubmitHandler, {
      ...
      value: evt => {
        ...
        this._callback.formSubmit(SiteEditPointView.parseDataToEvent(this._data));
      }
    });

    _defineProperty(this, "setFormSubmitHandler", callback => {
      this._callback.formSubmit = callback;
      this.getElement().querySelector('form').addEventListener('submit', _classPrivateFieldGet(this, _formSubmitHandler));
    });

    _defineProperty(this, "_deleteClickHandler", evt => {
      evt.preventDefault();

      this._callback.deleteClick(SiteEditPointView.parseDataToEvent(this._data));
    });

    _classPrivateFieldInitSpec(this, _eventTypeToggleHandler, {
      writable: true,
      value: evt => {
        const newEventType = _mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.eventTypes.filter(it => it.name === evt.target.value)[0];
        this.updateData({
          type: newEventType,
          offers: [],
          puctures: []
    ...
    _classPrivateFieldInitSpec(this, _eventOfferToggleHandler, {
      writable: true,
      value: evt => {
        const allOffersOfType = _classPrivateFieldGet(this, _allOffers).find(it => it.type === evt.target.dataset.typeName);
        ...
        if (index >= 0) {
          ...
          updateCheckedOffers.push({ ...allOffersOfType.offers.find(it => it.option.toLowerCase().replace(/ /g, '-') === evt.target.dataset.offerName),
            type: allOffersOfType.type
          });
        }
    ...
    _classPrivateFieldInitSpec(this, _eventDestinationToggleHandler, {
      writable: true,
      value: evt => {
        const index = _classPrivateFieldGet(this, _destinations).findIndex(destination => destination.name === evt.target.value);

        this.updateData({
          townName: evt.target.value,
          description: _classPrivateFieldGet(this, _destinations)[index].description,
          pictures: _classPrivateFieldGet(this, _destinations)[index].pictures
        });
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _setInnerHandlers, {
      ...
      value: () => {
        ...
        this.getElement().querySelector('input[name=event-destination]').addEventListener('change', _classPrivateFieldGet(this, _eventDestinationToggleHandler));
        this.getElement().querySelector('.event__input--price').addEventListener('input', _classPrivateFieldGet(this, _priceInputHandler));
        this.getElement().querySelector('input[name=event-destination]').addEventListener('change', _classPrivateFieldGet(this, _eventDestinationToggleHandler));
        Array.from(this.getElement().querySelectorAll('.event__offer-checkbox')).forEach(it => it.addEventListener('click', _classPrivateFieldGet(this, _eventOfferToggleHandler)));
      }
    });
    ...
    _classPrivateFieldSet(this, _allOffersOfType, allOffers.find(offer => offer.type === newPoint.type.name));
  ...
  get template() {
    if (this._data.newEvent) {
      return createNewEventFormTemplate(this._data, _classPrivateFieldGet(this, _allOffers), _classPrivateFieldGet(this, _destinations));
    } else {
      return createEditEventFormTemplate(this._data, _classPrivateFieldGet(this, _allOffers), _classPrivateFieldGet(this, _destinations));
    }
  }
...
class Filter extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    ...
    _defineProperty(this, "setFilterTypeChangeHandler", callback => {
      ...
      this.getElement().addEventListener('change', _classPrivateFieldGet(this, _filterTypeChangeHandler));
    });
  }
  ...
  get template() {
    return createSiteFilterTemplate(_classPrivateFieldGet(this, _currentFilter), _classPrivateFieldGet(this, _filters));
  }
...
<div class="trip-sort__item  trip-sort__item--day">
  <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DEFAULT}" checked>
...
const createSiteTabTemplate = (price, points) => {
  ...
  const sumDate = isMonthsEqual ? `${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(firstPoint.dateFrom).format('MMM DD')}&nbsp;&mdash;&nbsp;${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(lastPoint.dateTo).format('DD')}` : `${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(firstPoint.dateTo).format('MMM, DD')}&nbsp;&mdash;&nbsp;${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(lastPoint.dateTo).format('MMM, DD')}`;
...
var _sortPointList = /*#__PURE__*/new WeakMap();

class SiteTabView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
    return createSiteTabTemplate(_classPrivateFieldGet(this, _price), _classPrivateFieldGet(this, _points));
  }
  ...
  constructor(price, points) {
    ...
    _classPrivateFieldInitSpec(this, _sortPointList, {
      writable: true,
      value: (pointA, pointB) => {
        const dateFromA = pointA.dateFrom;
        const dateFromB = pointB.dateFrom;
        const weight = (0,_mock_mock_js__WEBPACK_IMPORTED_MODULE_1__.getWeight)(dateFromA, dateFromB);
        return weight !== null && weight !== void 0 ? weight : dateFromA - dateFromB;
      }
    });

    _classPrivateFieldSet(this, _points, points.sort(_classPrivateFieldGet(this, _sortPointList)));
...
/* harmony export */ });
/* harmony import */ var _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view.js */ "./src/view/abstract-view.js");
/* harmony import */ var _node_modules_chart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/chart.js */ "./node_modules/chart.js/dist/chart.esm.js");
/* harmony import */ var _node_modules_chartjs_plugin_datalabels_dist_chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels */ "./node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.js");
/* harmony import */ var _node_modules_chartjs_plugin_datalabels_dist_chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_chartjs_plugin_datalabels_dist_chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utilities_common_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utilities/common.js */ "./src/utilities/common.js");


_node_modules_chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart.register(..._node_modules_chart_js__WEBPACK_IMPORTED_MODULE_1__.registerables);
...
const renderMoneyChart = (moneyCtx, items) => {
  ...
  return new _node_modules_chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart(moneyCtx, {
    plugins: [(_node_modules_chartjs_plugin_datalabels_dist_chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default())],
    type: 'bar',
    data: {
      labels: data.labels,
      datasets: [{
...
const renderTransportChart = (transportCtx, items) => {
  ...
  return new _node_modules_chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart(transportCtx, {
    plugins: [(_node_modules_chartjs_plugin_datalabels_dist_chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default())],
    type: 'bar',
    data: {
      labels: data.labels,
...
const renderTimeSpendChart = (timeSpendCtx, items) => {
  ...
  return new _node_modules_chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart(timeSpendCtx, {
    plugins: [(_node_modules_chartjs_plugin_datalabels_dist_chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default())],
    type: 'bar',
    data: {
      labels: data.labels,
    ...
    options: {
      ...
      plugins: {
        datalabels: {
          ...
          anchor: 'end',
          align: 'start',
          formatter: val => `${(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_3__.humanizeDuration)(val)}`
        }
      },
      title: {
        display: true,
...
/* harmony import */ var _view_menu_view_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/menu-view.js */ "./src/view/menu-view.js");
...
/* harmony import */ var _api_api_service_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/api-service.js */ "./src/api/api-service.js");
...
const apiService = new _api_api_service_js__WEBPACK_IMPORTED_MODULE_6__.ApiService(END_POINT, AUTHORIZATION);
const pointsModel = new _model_point_model_js__WEBPACK_IMPORTED_MODULE_5__.PointsModel(apiService);
...
const tripPresenter = new _presenter_trip_presenter_js__WEBPACK_IMPORTED_MODULE_1__.TripPresenter(tripListContainer, tripControlsContainer, tripMainContainer, pointsModel);
const menuComponent = new _view_menu_view_js__WEBPACK_IMPORTED_MODULE_3__.Menu();
...
const handleSiteMenuClick = menuItem => {
  ...
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_4__.MenuItem.TABLE:
      (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(statisticsComponent);
      tripPresenter.init();
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_4__.MenuItem.STATS:
      tripPresenter.destroy();
      statisticsComponent = new _view_stats_js__WEBPACK_IMPORTED_MODULE_2__.Statistics(tripPresenter.points);
      (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsContainer, statisticsComponent.element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
      break;
  }
};
...
pointsModel.init().finally(() => {
  (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripControlsContainer, menuComponent.element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
