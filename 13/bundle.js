...
/* harmony export */ });
/* harmony import */ var _utilities_observer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utilities/observer.js */ "./src/utilities/observer.js");
...
class PointsModel extends _utilities_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    super(...args);
...
class EventNew {
  ...
  init() {
    ...
    _classPrivateFieldSet(this, _eventEditComponent, new _view_site_edit_point_view_js__WEBPACK_IMPORTED_MODULE_0__.SiteEditPointView((0,_mock_mock_js__WEBPACK_IMPORTED_MODULE_3__.generateClearPoint)()));
...
class TripPresenter {
  constructor(tripListContainer, tripControlsContainer, tripMainContainer, pointsModel) {
    ...
    _classPrivateFieldInitSpec(this, _noPointView, {
      writable: true,
      value: new _view_site_no_point_view_js__WEBPACK_IMPORTED_MODULE_4__.SiteNoPointView()
    });
    ...
    _classPrivateFieldInitSpec(this, _renderBoard, {
      ...
      value: () => {
        ...
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _noPointView));
        ...
        _classPrivateFieldGet(this, _eventNewPresenter).init();

        _classPrivateFieldGet(this, _renderPointsList).call(this);

        _classPrivateFieldSet(this, _siteTabComponent, new _view_site_tab_view_js__WEBPACK_IMPORTED_MODULE_10__.SiteTabView(_classPrivateFieldGet(this, _totalPrice)));
    ...
    _classPrivateFieldInitSpec(this, _renderNoPoint, {
      writable: true,
      value: () => {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripListContainer), _classPrivateFieldGet(this, _noPointView).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
      }
    });
...
const getOptionsArray = typeOfTrip => {
  const arr = [];
  _mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.allOffers.forEach(offer => offer.type === typeOfTrip ? arr.push(offer) : null);
  return arr;
};
...
const createEventFormTemplate = newPoint => {
  ...
  return `
    ...
    <datalist id="destination-list-1">
      ${_mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.townArray.map(it => `<option value="${it}"></option>`).join('\n')}
    </datalist>
  </div>
    ...
    _classPrivateFieldInitSpec(this, _eventOfferToggleHandler, {
      ...
      value: evt => {
        ...
        if (index >= 0) {
          ...
          updateCheckedOffers.push(allOffersOfPoint.find(it => it.option.toLowerCase().replace(/ /g, '-') === evt.target.dataset.offerName));
        }
...
class SiteTabView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
    return createSiteTabTemplate(_classPrivateFieldGet(this, _price));
  }
...
/* harmony import */ var _mock_mock_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock/mock.js */ "./src/mock/mock.js");
/* harmony import */ var _view_stats_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/stats.js */ "./src/view/stats.js");
/* harmony import */ var _model_point_model_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/point-model.js */ "./src/model/point-model.js");
/* harmony import */ var _view_menu_view_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/menu-view.js */ "./src/view/menu-view.js");
...
for (let i = 0; i < pointsCount; i++) {
  mocksArray.push((0,_mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.generatePoint)());
}

const pointsModel = new _model_point_model_js__WEBPACK_IMPORTED_MODULE_4__.PointsModel();
...
const menuComponent = new _view_menu_view_js__WEBPACK_IMPORTED_MODULE_5__.Menu();
...
const handleSiteMenuClick = menuItem => {
  ...
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_6__.MenuItem.TABLE:
      (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(statisticsComponent);
      tripPresenter.init();
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_6__.MenuItem.STATS:
      tripPresenter.destroy();
      statisticsComponent = new _view_stats_js__WEBPACK_IMPORTED_MODULE_3__.Statistics(tripPresenter.points);
...
menuComponent.setMenuClickHandler(handleSiteMenuClick); //render(tripFiltersElement, new SiteFilterView().element, RenderPosition.BEFOREEND);
