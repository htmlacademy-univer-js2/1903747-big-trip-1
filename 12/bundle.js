...
var _tripFiltersContainer = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(tripListContainer, tripFiltersContainer, tripMainContainer, pointsModel) {
    ...
    _classPrivateFieldInitSpec(this, _newPointButton, {
      writable: true,
      value: new _view_new_event_button_js__WEBPACK_IMPORTED_MODULE_9__.NewPointButton()
    });
    ...
    _classPrivateFieldInitSpec(this, _tripFiltersContainer, {
      writable: true,
      value: null
    });
    ...
    _defineProperty(this, "init", () => {
      ...
      (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripFiltersContainer), _classPrivateFieldGet(this, _filtersComponent).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
    ...
    _classPrivateFieldSet(this, _tripFiltersContainer, tripFiltersContainer);
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripMainContainer), _classPrivateFieldGet(this, _newPointButton).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
...
const createSiteFilterTemplate = currentFilterType => `<div class="trip-main__trip-controls  trip-controls">
...
for (let i = 0; i < pointsCount; i++) {
  mocksArray.push((0,_mock_mock_js__WEBPACK_IMPORTED_MODULE_3__.generatePoint)());
}
...
const tripPresenter = new _presenter_trip_presenter_js__WEBPACK_IMPORTED_MODULE_2__.TripPresenter(tripListContainer, tripFiltersContainer, tripMainContainer, pointsModel);
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripMainContainer, new _view_site_tab_view_js__WEBPACK_IMPORTED_MODULE_1__.SiteTabView().element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN); //render(tripFiltersElement, new SiteFilterView().element, RenderPosition.BEFOREEND);
