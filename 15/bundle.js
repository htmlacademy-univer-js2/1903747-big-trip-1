...
class TripPresenter {
  constructor(tripListContainer, tripControlsContainer, tripMainContainer, pointsModel) {
    ...
    _defineProperty(this, "init", () => {
      ...
      _classPrivateFieldSet(this, _filtersComponent, new _view_site_filter_view_js__WEBPACK_IMPORTED_MODULE_2__.Filter('everything'));
...
const createSiteFilterTemplate = currentFilterType => `<div class="trip-controls__filters">
              <h2 class="visually-hidden">Filter events</h2>
              <form class="trip-filters" action="#" method="get">
                <div class="trip-filters__filter">
                  <input id="filter-everything" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="everything" ${currentFilterType === 'future' ? 'checked' : ''} checked>
