...
const createEventFormTemplate = (newPoint, allOffers, destinations) => {
  ...
  const offers = newPoint.offers; //const isDisabled = newPoint.isDisabled;
      ...
      <div class="event__type-list">
        <fieldset class="event__type-group">
          <legend class="visually-hidden">Transfer</legend>
             ${Object.values(_mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.eventTypes).filter(it => it.action === 'to').map(it => createEditEventTypeTemplate(eventTypeName, it)).join('\n')}
        </fieldset>
        <fieldset class="event__type-group">
          <legend class="visually-hidden">Activity</legend>
             ${Object.values(_mock_mock_js__WEBPACK_IMPORTED_MODULE_2__.eventTypes).filter(it => it.action === 'in').map(it => createEditEventTypeTemplate(eventTypeName, it)).join('\n')}
        </fieldset>
      </div>
    </div>
    ...
    <datalist id="destination-list-1">
      ${destinations.map(it => `<option value="${it.name}"></option>`).join('\n')}
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_0__.humanizeDateInput)(dateFrom)}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${(0,_utilities_common_js__WEBPACK_IMPORTED_MODULE_0__.humanizeDateInput)(dateTo)}">
        </div>
      ...
      <section class="event__details">
        <section class="event__section  event__section--offers">
          ...
          <div class="event__available-offers">
            ${allOffersOfType === undefined ? offers.map(it => createEditEventOfferTemplate(it, offers, type)).join('\n') : allOffersOfType.offers.map(it => createEditEventOfferTemplate(it, offers, type)).join('\n')}
          </div>
        </section>
      </section>
