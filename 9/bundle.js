  ...
  return `<li class="trip-events__item">
              <div class="event">
                ...
                <div class="event__schedule">
                  ...
                  <p class="event__duration">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.tripDuration).format('HH')}H ${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.tripDuration).format('mm')}M</p>
                </div>
