...
/* harmony export */ });
/* harmony import */ var _view_site_list_content_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/site-list-content-view.js */ "./src/view/site-list-content-view.js");
...
class PointPresenter {
  constructor(tripListElement, changeData, changeMode) {
    ...
    _defineProperty(this, "init", pointObject => {
      ...
      _classPrivateFieldSet(this, _pointComponent, new _view_site_list_content_view_js__WEBPACK_IMPORTED_MODULE_0__.SitePointView(_classPrivateFieldGet(this, _pointObject)));
    ...
    _classPrivateFieldInitSpec(this, _replacePointToForm, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _tripListElement).replaceChild(_classPrivateFieldGet(this, _pointEditComponent).element, _classPrivateFieldGet(this, _pointComponent).element);
    ...
    _classPrivateFieldInitSpec(this, _setEditClick, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _pointEditComponent).element.querySelector('.event__rollup-btn').addEventListener('click', () => {
          _classPrivateFieldGet(this, _replaceFormToPoint).call(this);
        });
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _setFavoriteClick, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _pointObject).point.isFavorite = !_classPrivateFieldGet(this, _pointObject).point.isFavorite;
