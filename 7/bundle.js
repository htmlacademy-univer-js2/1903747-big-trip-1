...
/* harmony export */   "tripPoint": () => (/* binding */ tripPoint)
/* harmony export */ });
    ...
    <form class="event event--edit" action="#" method="post">
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.dateFrom).format('DD/MM/YY HH:MM')}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.dateTo).format('DD/MM/YY HH:MM')}">
        </div>
...
class SiteEditPointView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  get template() {
    return createSiteEditPointTemplate(_classPrivateFieldGet(this, _newPoint));
  }
...
const createSiteListContentTemplate = newPoint => {
  ...
  return `<ul class="trip-events__list">
            <li class="trip-events__item">
              <div class="event">
                <time class="event__date" datetime="2019-03-18">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.dateFrom).format('MMM, DD')}</time> 
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    <time class="event__start-time" datetime="2019-03-18T12:25">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.dateFrom).format('HH')}:${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.dateFrom).format('MM')}</time>
                    &mdash;
                    <time class="event__end-time" datetime="2019-03-18T13:35">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.dateTo).format('HH')}:${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.dateTo).format('MM')}</time>
                  </p>
                  <p class="event__duration">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.tripDuration).format('H')}H ${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(point.tripDuration).format('MM')}M</p>
                </div>
...
/* harmony import */ var _view_site_list_sort_view_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/site-list-sort-view.js */ "./src/view/site-list-sort-view.js");
...
/* harmony import */ var _view_site_list_content_view_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/site-list-content-view.js */ "./src/view/site-list-content-view.js");
/* harmony import */ var _view_site_edit_point_view_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/site-edit-point-view.js */ "./src/view/site-edit-point-view.js");
...
for (let i = 0; i < pointsCount; i++) {
  points.push(new _mock_mock_js__WEBPACK_IMPORTED_MODULE_5__.tripPoint((0,_mock_mock_js__WEBPACK_IMPORTED_MODULE_5__.generatePoint)()));
}

const renderPoint = (pointListElement, point) => {
  const pointComponent = new _view_site_list_content_view_js__WEBPACK_IMPORTED_MODULE_6__.SitePointView(point);
  const pointEditComponent = new _view_site_edit_point_view_js__WEBPACK_IMPORTED_MODULE_7__.SiteEditPointView(point);
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(mainComponent, new _view_site_tab_view_js__WEBPACK_IMPORTED_MODULE_1__.SiteTabView().element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripFilters, new _view_site_filter_view_js__WEBPACK_IMPORTED_MODULE_2__.SiteFilterView().element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);

if (points.every(point => point.isArchive)) {
  (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripList, new _view_site_no_point_view_js__WEBPACK_IMPORTED_MODULE_4__.SiteNoPointView().element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
} else {
  (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripList, new _view_site_list_sort_view_js__WEBPACK_IMPORTED_MODULE_3__.SiteSortView().element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN); //renderTemplate(tripList, createSiteNewPointTemplate(generatePoint()), 'afterbegin');
