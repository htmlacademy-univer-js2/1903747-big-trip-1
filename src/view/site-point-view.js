  ...
  return `<li class="trip-events__item">
              <div class="event">
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    <time class="event__start-time" datetime="2019-03-18T12:25">${dayjs(dateFrom).format('HH')}:${dayjs(dateFrom).format('mm')}</time>
                    &mdash;
                    <time class="event__end-time" datetime="2019-03-18T13:35">${dayjs(dateTo).format('HH')}:${dayjs(dateTo).format('mm')}</time>
                  </p>
                  <p class="event__duration">${dayjs(tripDuration).format('HH')}H ${dayjs(tripDuration).format('mm')}M</p>
                </div>
